...
[![hexlet-check](https://github.com/kimostas/frontend-project-44/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/kimostas/frontend-project-44/actions)
...
```bash
git clone https://github.com/kimostas/frontend-project-44.git
